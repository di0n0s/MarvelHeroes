...
public class APIFetchr { //Clase para establecer la conexión
    ...
    public List<MarvelHeroe> fetchItems(){
        ...
        try {
            ...
            parseItems(marvelHeroes, jsonBody);
    ...
    private void parseItems (List<MarvelHeroe> marvelHeroes, JSONObject jsonBody) throws JSONException { //Coge el JSON y lo alberga según el modelo de datos
